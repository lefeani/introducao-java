...
public class Client {
    ...
    @JsonIgnoreProperties("owner") // quando buscar os veiculos, não traga os proprietários                              
    private List<Vehicle> vehciles;
